...
namespace MCS.Library.Core.Data.DataObjects
{
    /// <summary>
	...
	public sealed class LruDictionary<TKey, TValue> : IEnumerable<KeyValuePair<TKey, TValue>>
    {
        ...
        {
            ExceptionHelper.TrueThrow<InvalidOperationException>(maxLruLength < 0,
                msg => new InvalidOperationException(msg), "maxLruLength must >= 0");
        ...
        {
            key.NullCheck("LruDictionary-Add-key");
        ...
        public TValue this[TKey key]
        {
            get
            {
                key.NullCheck("LruDictionary-get-key");
            ...
            set
            {
                key.NullCheck("LruDictionary-set-key");
        ...
        {
            key.NullCheck("LruDictionary-Remove-key");
        ...
        {
            key.NullCheck("LruDictionary-ContainsKey-key");
        ...
        {
            key.NullCheck("LruDictionary-TryGetValue-key");
